...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      practice_questions: {
        Row: { id:string; household_id:string; created_by:string; source_tier:string; kind:string; parent_question_ids:string[]|null; variation_type:string|null; fact_changes:Json; generation_metadata:Json; bar_year:number; exam_date:string|null; subject:string; question_number:string; question_text:string; source_url:string; source_page:number|null; source_fingerprint:string|null; course_id:string|null; reading_item_id:string|null; legal_cutoff_date:string|null; review_status:string; reviewed_by:string|null; reviewed_at:string|null; locked:boolean; answer_key:Json; edit_history:Json; created_at:string; updated_at:string }
        Insert: { id?:string; household_id:string; created_by:string; source_tier:string; kind?:string; parent_question_ids?:string[]|null; variation_type?:string|null; fact_changes?:Json; generation_metadata?:Json; bar_year:number; exam_date?:string|null; subject:string; question_number:string; question_text:string; source_url:string; source_page?:number|null; source_fingerprint?:string|null; course_id?:string|null; reading_item_id?:string|null; legal_cutoff_date?:string|null; review_status?:string; reviewed_by?:string|null; reviewed_at?:string|null; locked?:boolean; answer_key?:any; edit_history?:Json; created_at?:string; updated_at?:string }
        Update: { kind?:string; parent_question_ids?:string[]|null; variation_type?:string|null; fact_changes?:Json; generation_metadata?:Json; review_status?:string; reviewed_by?:string|null; reviewed_at?:string|null; locked?:boolean; updated_at?:string }
        Relationships: []
      }
      practice_attempts: {
